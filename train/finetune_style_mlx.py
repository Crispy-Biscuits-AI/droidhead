#!/usr/bin/env python3
# Minimal MLX LoRA fine-tune for style imitation
import argparse
...
def main():
    ...
    ap.add_argument("--base", required=True, help="HF model id")
    ap.add_argument("--train_jsonl", required=True, help="JSONL with {'prompt','response'}")
